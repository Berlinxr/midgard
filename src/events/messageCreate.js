...
const { owner, prefix, moderator } = require('../../berlin.json');
...
module.exports = {
    ...
    async execute(message, client) {
        ...
        if (command.onlyadmin && !message.member.roles.cache.has(moderator)) {
            return message.reply("Bu komutu kullanmaya yetkiniz yok. Sadece Adminler kullanabilir.");
        }
